...
Mesh::Mesh(std::string const & filename) : Mesh()
{
	...
	aiScene const * scene = loader.ReadFile(RESOURCES_PATH + "Models\\" + filename, aiProcessPreset_TargetRealtime_MaxQuality | aiProcess_OptimizeGraph | aiProcess_FlipUVs);
...
void Mesh::draw(Shader& shader)
{
	...
	{   // Set Correct Uniform Names Using Texture Type (Omit ID for 0th Texture)
		...
		shader.SetUniform1f(uniform, ++unit);
