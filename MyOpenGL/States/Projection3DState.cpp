#include "Projection3DState.h"
#include <stb/stb_image.h>
void Projection3DState::Init()
{
...
void Projection3DState::Pause()
{

}

void Projection3DState::Resume()
{
...
void Projection3DState::Render(StateManager* stateManager)
{
...
Projection3DState::~Projection3DState() {
	shader->Unbind();
	va->Unbind();
	vb->Unblind();
	ib->Unblind();
